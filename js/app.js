...
function printArray() {
	var msg = 'To add your region:\n'
	+ '1) Disable all territories using the "General" drop down on the right.\n'
	+ '2) Right Click on the map to add points to the region.\n'
	+ '3) Once the Region has been created using points, click "Add New Region"\n'
	+ '4) Copy and paste the below, editing all the <edit this>.\n'
	+ '5) If your browser does not support selecting the text below, press F12 to open the developer console and copy it from there.\n'
	+ 'Note: Scroll Down:\n\n';
	msg += '```json\n\t{\n\t\t"id": 0,'
	+ '\n\t\t"type": "Territories",'
	+ '\n\t\t"title": "<edit this>",'
	+ '\n\t\t"notes": "<edit this>",'
	+ '\n\t\t"wiki_link": "https://newdayrp.com/threads/<edit this>",'
	+ '\n\t\t"order": 0,'
	+ '\n\t\t"strokecolor": "FF0000",'
	+ '\n\t\t"fillcolor": "FF0000",'
	+ '\n\t\t"latlngarray": [\n';
	...
	msg += '\t\t]'
	+ '\n\t},\n "video": "<insert optional YT link here>"\n```';
	alert(msg);
	console.log(msg);
}
